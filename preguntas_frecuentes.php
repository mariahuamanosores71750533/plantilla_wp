                ...
                <div class="container-fluid">
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mb-3 font-weight-bold text-uppercase">COMPRAS</h5>
                                    <div id="accordion">
                                        <div class="card mb-1">
                                            ...
                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                                ...
                                                Selecciona un método de pago: Visa, Visa Electron, Mastercard, American Express...
                                        ...
                                        <div class="card mb-1">
                                            <div class="card-header bg-white border-bottom-0 p-3" id="headingTwo">
                                                <h5 class="m-0 font-size-16">
                                                    ...
                                                    2. ¿Es seguro comprar en la tienda online?
                                                    </a>
                                                </h5>
                                            </div>
                                        ...
                                        <div class="card mb-1">
                                            <div class="card-header bg-white border-bottom-0 p-3" id="headingThree">
                                                <h5 class="m-0 font-size-16">
                                                    ...
                                                    3. ¿Se reponen los artículos con la indicación “agotado”?
                                                    </a>
                                                </h5>
                                            </div>
